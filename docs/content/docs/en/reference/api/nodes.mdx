...
_openapi:
  ...
  toc:
    - depth: 2
      title: Set the panel display order for nodes.
      url: '#set-the-panel-display-order-for-nodes'
    - depth: 2
  ...
  structuredData:
    headings:
      - content: Set the panel display order for nodes.
        id: set-the-panel-display-order-for-nodes
