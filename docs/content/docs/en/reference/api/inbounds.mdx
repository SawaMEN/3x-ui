...
_openapi:
  ...
  toc:
    ...
    - depth: 2
      title: Set the panel display order for the authenticated user’s inbounds.
      url: '#set-the-panel-display-order-for-the-authenticated-users-inbounds'
    - depth: 2
  ...
  structuredData:
    headings:
      ...
      - content: Set the panel display order for the authenticated user’s inbounds.
        id: set-the-panel-display-order-for-the-authenticated-users-inbounds
