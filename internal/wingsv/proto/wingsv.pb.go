...
const file_wingsv_proto_rawDesc = "" +
	"\n" +
	"\fwingsv.proto\x12\x06wingsv\"\xe1\x02\n" +
	"\x06Config\x12\x10\n" +
...
var (
	file_wingsv_proto_enumTypes = make([]protoimpl.EnumInfo, 6)
	file_wingsv_proto_msgTypes  = make([]protoimpl.MessageInfo, 16)
	file_wingsv_proto_goTypes   = []any{
...
func file_wingsv_proto_init() {
	...
	file_wingsv_proto_msgTypes[5].OneofWrappers = []any{}
	...
	file_wingsv_proto_msgTypes[12].OneofWrappers = []any{}
