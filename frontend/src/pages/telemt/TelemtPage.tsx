            ...
            <div className="telemt-shell">
                  ...
                  <Row gutter={16}>
                    ...
                    <Col xs={24} md={16}>
                      <Form.Item
                        ...
                        rules={[{ required: true, message: 'Введите IP или домен' }]}
                      >
                        <Input placeholder="proxy.example.com или IP-адрес" />
                      </Form.Item>
                    </Col>
                  </Row>
                  <Button
              ...
              >
                <Form form={form} layout="vertical" onFinish={save} initialValues={defaults}>
                  ...
                  <Row gutter={16}>
                    <Col xs={24} md={12}>
                      <Form.Item
                        name="sni"
                        label="SNI"
                        tooltip="Домен, который используется как tls_domain для Fake-TLS"
                      >
                    ...
                    <Col xs={24} md={12}>
                      <Form.Item name="tls" label="Fake-TLS (ee)" valuePropName="checked">
                        <Switch
                          onChange={(checked) => {
                            if (checked && !form.getFieldValue('sni'))
                              form.setFieldValue('sni', 'petrovich.ru');
                          }}
                        />
                      </Form.Item>
                    </Col>
                  ...
                  <Row gutter={16}>
                    <Col xs={24} md={8}>
                      <Form.Item name="ipv4" label="Разрешить IPv4" valuePropName="checked">
                        <Switch />
                      </Form.Item>
                    </Col>
                    <Col xs={24} md={8}>
                      <Form.Item name="ipv6" label="Разрешить IPv6" valuePropName="checked">
                        <Switch />
                      </Form.Item>
                    </Col>
                    <Col xs={24} md={8}>
                  ...
                  <Space wrap>
                    ...
                    <Button
                      htmlType="button"
                      onClick={() => action(status.enabled ? 'disable' : 'enable')}
                    >
                      {status.enabled ? 'Отключить автозапуск' : 'Включить автозапуск'}
                    </Button>
                    <Button
                      htmlType="button"
                      icon={<SyncOutlined />}
                      ...
                      loading={loading}
                      disabled={!status.installed || !status.updateAvailable}
                    >
                      Обновить Telemt
                    </Button>
                  </Space>
